...
const App = () => {
  ...
  return (
    <div className="wrapper">
      ...
      <ToDoList onToggle={onToggle} onDelete={onDelete} onImportant={onImportant} todoItems={visibleData}/>
      <CreateNewElement onAdded={onAdded}/>
      <Statistics active={countActiveTasks} important={countImpTasks} />
    </div>
  );
}
